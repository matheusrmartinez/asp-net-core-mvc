...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new DateTime(1998, 4, 21), 1500.0, d2);

            SalesRecord r1 = new SalesRecord(1, new DateTime(2019, 02, 20), 11000.0, SaleStatus.Billed, s1);
